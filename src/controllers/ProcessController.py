...
class ProcessController(BaseController):
    ...
    def get_file_extension(self, file_id: str) -> str:
        # Implement logic to extract file extension from file_id
        file_extension = os.path.splitext(file_id)[-1]

        return file_extension

    def get_file_loader(self, file_id: str) -> str:
        # Implement logic to load document based on file extension
    ...
    def get_file_content(self, file_id: str) -> str:
        ...
        return file_loader.load()  #list of Document objects(page_content, metadata)
    
    def split_file_content(self, file_id: str, chunk_size: int=100, overlap_size: int=20):
